    ...
    <div className='flex p-3 cursor-pointer border-b border-gray-200'>
        ...
        {/* header */}
            ...
            <div className='flex items-center justify-between'>
              ...
              {/* post text */}
            <p onClick= {() => router.push(`/posts/${id}`)} className='text-gray-700 text-[15px] sm:text-[16px] mb-2'>{post?.data()?.text}</p>
              {/* post image */}
            <img onClick={() => router.push(`/posts/${id}`)} className='rounded-2xl mr-2' src={post?.data()?.image} alt='post image' />
              {/* icons */}
